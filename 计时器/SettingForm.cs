...
namespace 计时器
{
	public partial class SettingForm : Form
	{
		...
		private void nud总时长_ValueChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}
		...
		private void cb字体_SelectedIndexChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}
		...
		private void nud字号_ValueChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}

		private void cb时间格式_SelectedIndexChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}
		...
		private void nud阴影距离_ValueChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}

		private void nud阴影的透明度_ValueChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}

		private void cb阴影描边_CheckedChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}
		...
		private void cb结束提示音文件_SelectedIndexChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}
		...
		private void nud预警时长_ValueChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}

		private void cb预警提示音文件_SelectedIndexChanged(object sender, EventArgs e)
		{
			this.发送设置已更改通知();
		}
