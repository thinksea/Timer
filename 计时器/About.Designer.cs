namespace 计时器
{
	partial class About
	{
        ...
        private void InitializeComponent()
        {
            ...
            richTextBox1.Location = new Point(32, 15);
            richTextBox1.Margin = new Padding(6, 5, 6, 5);
            richTextBox1.Name = "richTextBox1";
            richTextBox1.ReadOnly = true;
            richTextBox1.Size = new Size(838, 763);
            richTextBox1.TabIndex = 0;
            richTextBox1.Text = "计时器 v1.0\n\n功能：\n1、正向计时\n2、倒计时\n\n修改音频：\n将音频文件放置在“sound”目录即可。\n支持的音频文件格式：wav\n\n快捷键：\nF2：开始计时|继续计时\nF3：暂停计时|继续计时\nF4：停止计时";
            // 
            // btnCancel
            // 
            btnCancel.DialogResult = DialogResult.Cancel;
            btnCancel.Location = new Point(346, 799);
